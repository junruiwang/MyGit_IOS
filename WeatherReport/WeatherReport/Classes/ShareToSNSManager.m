...
- (void)shareWithActionSheet:(BannerViewController *)controller shareImage:(UIImage *)shareImage shareText:(NSString *)shareText
{
    ...
    [UMSocialSnsService presentSnsIconSheetView:_viewController.tabBarController appKey:kUMengShareKey shareText:shareText shareImage:shareImage shareToSnsNames:snsNames delegate:self];
}
