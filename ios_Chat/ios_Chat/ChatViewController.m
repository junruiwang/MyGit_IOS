...
-(void)openUDPServer{
	...
	//绑定端口
	NSError *error = nil;
	[self.udpSocket bindToPort:8001 error:&error];
...
//    [socket sendData:data toHost:@"192.168.1.100" port:8001 withTimeout:-1 tag:1];
//    NSLog(@"send upd complete.");
	...
	UIView *chatView = [self bubbleView:[NSString stringWithFormat:@"%@:%@", NSLocalizedString(self.myIP,nil), message]
								   from:YES];
