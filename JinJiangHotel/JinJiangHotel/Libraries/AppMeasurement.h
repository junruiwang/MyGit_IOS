...
@property(readwrite, assign) unsigned int offlineLimit;
...
@property(readwrite, strong) AppMeasurementModuleMedia * Media;
@property(readwrite,strong) NSMutableArray * queuedMessages;
@property(readwrite, strong) NSMutableDictionary * contextData;
@property(readwrite, strong) NSMutableDictionary * retrieveLightData;
...
@property(readwrite, strong) NSMutableDictionary * contextDataMapping;
